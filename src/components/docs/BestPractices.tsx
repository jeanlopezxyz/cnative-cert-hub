...
const MAIN_CATEGORIES: MainCategoryConfig[] = [
  ...
  },
  {
    ...
    icon: CategoryIcons.applications,
  ...
  },
  {
    ...
    icon: CategoryIcons.observability,
    color: 'from-emerald-500 to-emerald-600',
    subcategories: ['observability', 'storage'],
  },
  {
    id: 'cicd',
    labelKey: 'bestPractices.category.cicd',
    icon: CategoryIcons.cicd,
...
export default function BestPractices({ lang }: BestPracticesProps) {
  ...
  const [activeMainCategory, setActiveMainCategory] = useState<MainCategoryType>('infrastructure');
