    ...
    courses: [
      {
        ...
        description: 'Essential Kubernetes foundation for service mesh concepts',
        isPaid: false,
        duration: '16 hours',
        difficulty: 'beginner',
        rating: 4.8,
      },
      {
        ...
        author: 'The Linux Foundation',
        description: 'Free introductory course covering Istio service mesh fundamentals',
        isPaid: false,
        duration: '8 hours',
        difficulty: 'intermediate',
        rating: 4.7,
      ...
      {
        title: 'Istio Service Mesh Essentials (LFS245)',
        url: 'https://training.linuxfoundation.org/training/istio-service-mesh-essentials-lfs245/',
        author: 'The Linux Foundation',
        description: 'Comprehensive paid course specifically designed for ICA preparation',
        isPaid: true,
        duration: '35 hours',
        difficulty: 'advanced',
        rating: 4.8,
