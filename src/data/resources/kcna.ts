...
export const kcnaResources: CertificationResources = {
  ...
  courses: [
    ...
    },
    {
      ...
      author: 'The Linux Foundation',
      description: 'Learn the principles and practices of DevOps and SRE',
      isPaid: false,
    ...
    },
    {
      ...
      author: 'The Linux Foundation',
      description: 'Learn how to build serverless functions that can run on any cloud',
      isPaid: false,
    ...
    },
    {
      ...
      author: 'The Linux Foundation',
      description: 'Learn Cilium as the networking plug-in for Kubernetes',
      isPaid: false,
