...
export const capaResources: CertificationResources = {
  ...
  books: [
    ...
    },
    {
      ...
      author: 'Pavan Kumar',
      description: 'Master Argo Workflows for Kubernetes automation',
      isPaid: true,
      format: 'paperback',
      year: 2023,
      difficulty: 'intermediate',
    },
    {
      ...
      description: 'GitOps patterns with Argo CD and Kubernetes',
      isPaid: true,
      format: 'paperback',
      year: 2021,
      difficulty: 'intermediate',
  ...
  videos: [
    {
      ...
      author: 'KodeKloud',
      description: 'Container fundamentals - prerequisite for CAPA',
      isPaid: true,
      duration: '4 hours',
      difficulty: 'beginner',
    },
    {
      ...
      author: 'KodeKloud',
      description: 'Kubernetes basics - prerequisite for CAPA',
      isPaid: true,
      duration: '6 hours',
      difficulty: 'beginner',
    },
    {
      ...
      url: 'https://kodekloud.com/courses/certified-argo-project-associate-capa/',
      author: 'KodeKloud',
      description: 'Complete CAPA preparation with hands-on Argo labs',
      isPaid: true,
      duration: '15 hours',
      difficulty: 'intermediate',
    },
