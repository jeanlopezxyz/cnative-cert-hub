...
export const lfcsResources: CertificationResources = {
  ...
  books: [
    ...
    },
    {
      ...
      description: 'Comprehensive Linux administration guide - covers Ubuntu 24 LTS, Fedora 41, RHEL 9',
      isPaid: true,
      format: 'paperback',
      year: 2024,
      difficulty: 'beginner',
    ...
    },
    {
      ...
      description: 'Complete guide to the Linux command line (Free)',
      isPaid: false,
      format: 'pdf',
      year: 2019,
      difficulty: 'beginner',
    },
    {
      ...
      url: 'https://www.oreilly.com/library/view/linux-pocket-guide/9781098157968/',
