...
export const icaResources: CertificationResources = {
  ...
  books: [
    ...
    },
    {
      ...
      description: 'Using a service mesh to connect, secure, control, and observe',
      isPaid: true,
      format: 'paperback',
      year: 2020,
      difficulty: 'beginner',
  ...
  videos: [
    {
      ...
      author: 'KodeKloud',
      description: 'Container fundamentals - prerequisite for ICA',
      isPaid: true,
      duration: '4 hours',
      difficulty: 'beginner',
    },
    {
      ...
      author: 'KodeKloud',
      description: 'Kubernetes basics - prerequisite for ICA',
      isPaid: true,
      duration: '6 hours',
      difficulty: 'beginner',
    },
    {
      ...
      url: 'https://kodekloud.com/courses/istio-certified-associate',
      author: 'KodeKloud',
      description: 'Complete ICA preparation with hands-on Istio labs',
      isPaid: true,
      duration: '15 hours',
      difficulty: 'intermediate',
    },
