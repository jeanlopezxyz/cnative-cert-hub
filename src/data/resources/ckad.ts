...
export const ckadResources: CertificationResources = {
  ...
  videos: [
    {
      ...
      author: 'KodeKloud',
      description: 'Container fundamentals - essential prerequisite for CKAD',
      isPaid: true,
      duration: '4 hours',
      difficulty: 'beginner',
    },
    {
      ...
      author: 'KodeKloud',
      description: 'Kubernetes basics with hands-on labs - prerequisite for CKAD',
      isPaid: true,
      duration: '6 hours',
      difficulty: 'beginner',
    },
    {
      ...
      url: 'https://kodekloud.com/courses/certified-kubernetes-application-developer-ckad/',
      author: 'KodeKloud',
      description: 'Complete CKAD preparation with hands-on labs',
      isPaid: true,
      duration: '15 hours',
      difficulty: 'intermediate',
    },
    {
      ...
      description: 'Complete CKAD preparation covering all exam topics (Free)',
      isPaid: false,
      duration: '4 hours',
      difficulty: 'intermediate',
    },
  ...
  blogs: [
    ...
    },
    {
      ...
      url: 'https://kodekloud.com/blog/ckad-exam-preparation-guide/',
      author: 'KodeKloud',
