...
export const ccaResources: CertificationResources = {
  ...
  books: [
    ...
    {
      title: 'eBPF & Cilium Networking for Network Engineers',
      url: 'https://isovalent.com/books/ebpf-cilium-networking/',
      author: 'Isovalent',
      description: 'FREE - Deep dive into eBPF-based networking with Cilium',
      isPaid: false,
      format: 'ebook',
      year: 2024,
      difficulty: 'intermediate',
    ...
    {
      title: 'Cilium CCA Study Guide',
      url: 'https://github.com/isovalent/CCA-Study-Guide',
      author: 'Isovalent',
      description: 'FREE - Official study guide for CCA certification from Cilium creators',
      isPaid: false,
      format: 'ebook',
      year: 2024,
      difficulty: 'intermediate',
    ...
    // PAID BOOKS
    {
      ...
      description: 'Comprehensive guide from Isovalent team - creators of Cilium',
      isPaid: true,
      format: 'paperback',
      year: 2025,
      difficulty: 'intermediate',
